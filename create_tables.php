...
if ($conn->query($sql1)) {
    echo "✅ subscription_plans table created<br>";
} else {
    echo "❌ Error creating subscription_plans: " . $conn->error . "<br>";
}
...
if ($conn->query($sql2)) {
    ...
    echo "❌ Error creating blog_categories: " . $conn->error . "<br>";
}
...
if ($conn->query($sql3)) {
    echo "✅ blog_posts table created<br>";
} else {
    echo "❌ Error creating blog_posts: " . $conn->error . "<br>";
}
...
if ($conn->query($sql4)) {
    echo "✅ client_subscriptions table created<br>";
} else {
    echo "❌ Error creating client_subscriptions: " . $conn->error . "<br>";
}
...
if ($row['cnt'] == 0) {
    ...
    echo "✅ Sample subscription plans added<br>";
}

// Check if blog_categories has data
...
if ($row['cnt'] == 0) {
    ...
    echo "✅ Sample blog categories added<br>";
}

echo "<br><h3>Done! All tables created successfully.</h3>";
