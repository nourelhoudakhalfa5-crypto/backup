...
<head>
    ...
    <title>RDOC - Analyse et gestion</title>
    ...
    <section class="py-16 sm:py-20 md:py-24 lg:py-[100px]">
        <div class="container mx-auto px-6">
            <div class="text-center mb-8 sm:mb-10 md:mb-12 lg:mb-[60px]">
                <h2 class="section-main-title">Une solution de gestion intelligente sans limites</h2>
            </div>
            <div class="solution-grid grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8">
                <div class="solution-card"><div class="card-image h-40 md:h-60 lg:h-[250px]"><img src="assets/images/gestion/image2.png" alt="Robot"></div><div class="card-info p-4 md:p-6"><h3>Gestion et Organisation</h3><p>Le robot facilite la planification et le suivi des tâches</p></div></div>
                <div class="solution-card"><div class="card-image h-40 md:h-60 lg:h-[250px]"><img src="assets/images/gestion/image3.png" alt="Infos"></div><div class="card-info p-4 md:p-6"><h3>INFOS UTILES</h3><p>Tout savoir rapidement</p></div></div>
            </div>
            <div class="text-center"><a href="produit-aihrus.php" class="btn-discover-more">Découvrir</a></div>
        </div>
    </section>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 items-center gap-10">
           ...
           <div class="flex flex-col gap-6 pl-36">
            ...
            <div class="flex justify-center">
                <img 
                    src="assets/images/gestion/image4.png"
                    alt="Robot"
                    class="sensor-robot"
                >
            </div>
