...
<html lang="fr">
  <head>
    ...
    <meta name="description" content="RDOC - Robot ̩ducatif intelligent. Solution autonome pour l'̩ducation et l'assistance." />
    <title>Aisar</title>
    ...
    <section class="max-w-container mx-auto px-4 sm:px-6 py-16 sm:py-20 md:py-24">
       <div class="flex flex-col md:flex-row items-center gap-8 md:gap-12 lg:gap-16">
          <div class="w-full md:w-5/12 flex justify-center relative">
             ...
             <img src="assets/images/product/Gemini_Generated_Image_ewxq1eewxq1eewxq-removebg-preview (1) 1.png" alt="RDOC Pro Profile" class="w-full max-w-[320px] sm:max-w-[300px] md:w-[85%] h-auto relative z-10">
          </div>
