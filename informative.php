...
<section class="categorie-hero relative overflow-hidden min-h-screen flex items-center">
    ...
    >
        <source src="assets/videocategorieinformative.mp4" type="video/mp4">
    </video>
    ...
    <section class="py-16 sm:py-20 md:py-24 lg:py-[100px]">
        <div class="container mx-auto px-6">
            <div class="text-center mb-8 sm:mb-10 md:mb-12 lg:mb-[60px]">
                <h2 class="section-main-title">Une solution informative sans limites</h2>
            </div>
            <div class="solution-grid grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8">
                <div class="solution-card"><div class="card-image h-40 md:h-60 lg:h-[250px]"><img src="assets/images/informative/Gemini_Generated_Image_eb0tv6eb0tv6eb0t 3.png" alt="Robot"></div><div class="card-info p-4 md:p-6"><h3>ROBOT EN CLIENT</h3><p>Inspiration et ressources</p></div></div>
                <div class="solution-card"><div class="card-image h-40 md:h-60 lg:h-[250px]"><img src="assets/images/informative/Gemini_Generated_Image_y4jrwly4jrwly4jr 1.png" alt="Infos"></div><div class="card-info p-4 md:p-6"><h3>INFOS UTILES</h3><p>Innovation et enseignement</p></div></div>
            </div>
            <div class="text-center"><a href="produit-aivish.php" class="btn-discover-more">Découvrir</a></div>
        </div>
    </section>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 items-center gap-10">
           ...
           <div class="flex flex-col gap-6 pl-36">
            ...
            <div class="flex justify-center">
                <img 
                    src="assets/images/informative/robotcapteur.png"
                    alt="Robot"
                    class="sensor-robot"
                >
            </div>
