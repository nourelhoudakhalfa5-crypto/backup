...
<?php include 'includes/nav.php'; ?>
   ...
   <!-- HERO -->
<section class="categorie-hero pt-0 lg:pt-0 -mt-6 lg:-mt-10 relative overflow-hidden">
    ...
    >
        <source src="assets/images/educative/videoeducative.mp4" type="video/mp4">
    </video>
        ...
        <div class="container mx-auto px-4 sm:px-6">
            <div class="categorie-hero-text max-w-[900px] mx-auto">
                ...
                <p class="cat-hero-subtitle">
                    Des expériences éducatives interactives pour stimuler la créativité, la curiosité et l’apprentissage intelligent des enfants.
                </p>
    ...
    <section class="py-16 sm:py-20 md:py-24 lg:py-[100px]">
        <div class="container mx-auto px-6">
            <div class="text-center mb-8 sm:mb-10 md:mb-12 lg:mb-[60px]">
                <h2 class="section-main-title">Une solution éducative sans limites</h2>
            </div>
            <div class="solution-grid grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8">
                <div class="solution-card"><div class="card-image h-40 md:h-60 lg:h-[250px]"><img src="assets/images/educative/image edu.png" alt="Robot"></div><div class="card-info p-4 md:p-6"><h3> Pour les étudiants</h3><p>Mieux comprendre, plus vite</p></div></div>
                <div class="solution-card"><div class="card-image h-40 md:h-60 lg:h-[250px]"><img src="assets/images/educative/image edu2.png" alt="Infos"></div><div class="card-info p-4 md:p-6"><h3>Pour les professionnels</h3><p>Travailler plus intelligemment</p></div></div>
            </div>
